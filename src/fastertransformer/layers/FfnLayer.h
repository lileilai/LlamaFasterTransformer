...
// #include "src/fastertransformer/kernels/elementwise_mul.h"
#include <stdint.h>
#include <vector>
...
// template<typename T>
// class LlamaGeluFfnLayer: public FfnLayer<T> {
// public:
//     LlamaGeluFfnLayer(size_t           max_batch_size,
//                  size_t           max_seq_len,
//                  size_t           head_num,
//                  size_t           size_per_head,
//                  size_t           expert_num,
...
//     LlamaGeluFfnLayer(LlamaGeluFfnLayer<T> const& llama_ffn_layer);

//     virtual ~LlamaGeluFfnLayer() = default;

//     virtual void forward(std::vector<fastertransformer::Tensor>*       output_tensors,
//                          const std::vector<fastertransformer::Tensor>* input_tensors,
//                          const LlamaFfnWeight<T>*                           ffn_weights);
//     virtual void forward(TensorMap* output_tensors, TensorMap* input_tensors, const LlamaFfnWeight<T>* ffn_weights);

// protected:
//     using FfnLayer<T>::stream_;
//     using FfnLayer<T>::cublas_wrapper_;
//     using FfnLayer<T>::hidden_units_;
//     using FfnLayer<T>::is_free_buffer_after_forward_;
//     virtual ActivationType getActivationType() const override
//     {
//         return ActivationType::Gelu;
//     };
